...
public struct SlashCommandOption: Identifiable, Hashable, Sendable {
    ...
    public static let all: [SlashCommandOption] = [
        ...
        SlashCommandOption(kind: .providerNative, command: "/handoff", title: "Handoff", detail: "Move the active Hermes session to a messaging platform such as Discord.", symbol: "arrowshape.turn.up.right", badge: "Hermes", supportedAgents: ["hermes"]),
        SlashCommandOption(kind: .providerNative, command: "/sethome", title: "Set Home", detail: "Show or configure the gateway home channel used for handoff.", symbol: "house.and.flag", badge: "Hermes", supportedAgents: ["hermes"]),
