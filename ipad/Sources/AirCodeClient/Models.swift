...
public struct SlashCommandOption: Identifiable, Hashable, Sendable {
    ...
    public static let all: [SlashCommandOption] = [
        ...
        SlashCommandOption(kind: .speed, command: "/fast", title: "Fast Mode", detail: "Forward provider-native fast mode when supported.", symbol: "hare", badge: "Codex", supportedAgents: ["codex"]),
